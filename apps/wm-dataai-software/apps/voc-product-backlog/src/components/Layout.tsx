...
const stepsInOrder: { id: StepId, label: string }[] = [
  { id: 'ingest', label: '1. VOC Sources' },
  { id: 'cluster', label: '2. Cluster Themes' },
  { id: 'link', label: '3. Link to ARR' },
  { id: 'brief', label: '4. Opportunity Brief' },
  { id: 'prioritize', label: '5. Priority Gate' },
  { id: 'handoff', label: '6. Backlog Handoff' }
];
  ...
  return (
    <div className="min-h-screen bg-wm-gray-light/30 flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col w-full mx-auto pb-24">
        {isDemo ? (
          <div className="flex flex-col lg:flex-row-reverse max-w-[1600px] mx-auto w-full">
            <aside className="lg:w-[238px] shrink-0 lg:border-l border-wm-gray-med bg-white lg:sticky lg:top-0 lg:self-start lg:min-h-screen px-4 py-5">
