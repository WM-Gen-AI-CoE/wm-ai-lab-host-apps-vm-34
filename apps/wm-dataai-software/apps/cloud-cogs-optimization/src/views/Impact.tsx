...
// Gross-margin bridge for the workload change set (illustrative monthly figures).
const bridge = [
  { label: 'Starting gross margin', value: '74%', kind: 'base' as const },
  { label: 'Rightsize to job cluster', value: '+1.6 pts', kind: 'up' as const },
  { label: 'Replica copy to on-demand', value: '+1.0 pts', kind: 'up' as const },
  { label: 'Storage tiering', value: '+0.2 pts', kind: 'up' as const },
  { label: 'Other workloads (in flight)', value: '+1.2 pts', kind: 'up' as const },
  { label: 'Ending gross margin', value: '78%', kind: 'base' as const },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-wm-blue text-white rounded-xl p-6 shadow-md">
        ...
        <p className="text-white/70 text-sm">Rightsized run completed at 02:40 AM, under the 06:00 SLA. Realized compute cost down 19% on the first cycle; savings tracked against billing, not projection.</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg border border-wm-gray-med shadow-sm p-4">
          ...
          <p className="text-xs text-wm-gray-dark mt-1">Realized on the first run after rightsizing, in line with the projection.</p>
        </div>
        <div className="bg-white rounded-lg border border-wm-gray-med shadow-sm p-4">
          ...
          <p className="text-2xl font-bold text-green-600">{usd(25900)}<span className="text-sm font-normal text-wm-gray-dark">/mo</span></p>
          <p className="text-xs text-wm-gray-dark mt-1">From approved rightsize, schedule, and tiering changes on this workload.</p>
        </div>
        <div className="bg-white rounded-lg border border-wm-gray-med shadow-sm p-4">
